  ...
  return (
    <>
      <main className='flex items-center justify-center w-full min-h-screen bg-gradient-to-br from-slate-200 to-slate-500'>
        <div className='flex flex-col items-start gap-4 bg-white rounded shadow p-4 mx-16 my-4'>
          <div className='flex items-center gap-4'>
            <button className='px-1 text-blue-600 hover:scale-110 transition-all' onClick={() => navigate(-1)}>
              <svg
